void getStack(const TString fin, const TString anaid, const TString tag, const TString var)
{
  ...
  if(var.Contains("VS")){
    ...
    */
    ...
    TString tit[]={"all", "QE 0#pi^{0}", "QE 1#pi^{0}", "QE multi-#pi^{0}", "RES 0#pi^{0}", "RES 1#pi^{0}", "RES multi-#pi^{0}", "DIS 0#pi^{0}", "DIS 1#pi^{0}", "DIS multi-#pi^{0}", "2p2h 0#pi^{0}", "2p2h 1#pi^{0}", "2p2h multi-#pi^{0}"};
